...
$("#loginformsubmit").click(function(){
	...
	if(code==null||pwd==null)
		$("#errorInfo").html= '账号或密码为空,请填写后登陆.';
	else
		{
		$("#userPwd").val(hex_sha1(pwd));
		$("#loginform").submit();
		}
})
...
$("#passwordFormsubmit").click(function(){
	...
	var repsd=$('#passwordForm-repsd').val();
	if(oldpsd==null||newpsd==null||repsd==null||oldpsd==""||newpsd==""||repsd=="")
	{	$("#passwordFormerrorInfo").text('请填写完整.');}
	else if(newpsd!=repsd)
	{	$("#passwordFormerrorInfo").text('新密码,两次输入不同.');}
